...
* Day 6: Chronal Coordinates
  ...
  #+begin_src sh
    nim c -r src/chronal_coordinates data/6.txt
  #+end_src
  ...
  as part of our behavior. Time for a default command line arg I guess? Anyway
  let's hash out the solution for the smaller test case anyway.
...
* Day 7: The Sum of Its Parts
  ...
  #+begin_src sh
    nim c -r src/the_sum_of_its_parts data/7.txt
  #+end_src
